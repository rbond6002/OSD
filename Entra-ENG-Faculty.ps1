...
# Copy AutoPilot.ps1
$autoSrc = 'X:\OSDCloud\Config\Scripts\AutoPilotCert_Entra-ENG-Faculty.ps1'
    ...
    <component name="Microsoft-Windows-Deployment"
      ...
      <RunSynchronous>
        <RunSynchronousCommand wcm:action="add">
          ...
          <Path>PowerShell -ExecutionPolicy Bypass -File C:\AutoPilotHash\AutoPilotCert_Entra-ENG-Faculty.ps1</Path>
